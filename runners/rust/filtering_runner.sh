...
BINARY_PATH="../../rs-methods/target/release/filtering-performance"

# Define separate CSV files for timing and memory
TIMING_CSV="../../timings/rust/filtering_performance.csv"
MEMORY_CSV="../../timings/rust/filtering_memory.csv"

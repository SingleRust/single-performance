...
BINARY_PATH="../../rs-methods/target/release/normalization-performance"

# Define separate CSV files for timing and memory
TIMING_CSV="../../timings/rust/normalization_performance.csv"
MEMORY_CSV="../../timings/rust/normalization_memory.csv"
